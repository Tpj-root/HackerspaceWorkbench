# About translating hacker_space_workbench Workbench

> [!NOTE]
> All commands **must** be run in `./freecad/hacker_space_workbench/resources/translations/` directory.
...
at <https://crowdin.com/project/freecad-addons> webpage and find the **hacker_space_workbench** project.

## Creating file for missing locale

### Using script

To create a file for a new language with all **hacker_space_workbench** translatable strings execute
...
Also you can rename new `hacker_space_workbench.ts` file by appending the locale code,
...
once done, look for the **hacker_space_workbench** project.
...
Now you can contribute your translated `.ts` file to **hacker_space_workbench** repository,
also include the `.qm` file.

<https://github.com/Tpj-root/HackerspaceWorkbench>
